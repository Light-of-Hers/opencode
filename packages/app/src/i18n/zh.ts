...
export const dict = {
  ...
  "settings.general.notifications.browser.default.title": "浏览器通知权限",
  "settings.general.notifications.browser.default.description": "授予浏览器通知权限，以便应用在后台时仍可接收通知。",
  "settings.general.notifications.browser.denied.title": "浏览器通知已被阻止",
  "settings.general.notifications.browser.denied.description": "通知已被阻止。请在浏览器站点设置中重新启用。",
  "settings.general.notifications.browser.grant": "授权",
